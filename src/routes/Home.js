        ...
        return(
            <>
                ...
                <section className='narrow page-section'>
                    ...
                    <p className='section-description'>While this project is in no way, shape or form afilliated with Space X, it derives all of its data from the <a href='https://github.com/r-spacex/SpaceX-API/tree/master/docs/v4' target='_blank' rel='noreferrer'>unofficial Space X API</a>, which gets its data from SpaceX directly. The purpose of this project is to showcase my skills as a developer, and to also show people some fun information about what Space X gets up to. Click the button below to learn more about the project, and explore this Single Page Application to see more from Space X!</p>
                ...
                <section className='breakthroughs page-section'>
                    ...
                    <div className='content-container'>
                        {data.breakthroughs.map((breakthrough, index) => {
                            return index < 4 && <BreakthroughCard cardDetails={breakthrough} number={index + 1} key={breakthrough.id} />
                        })}
                    </div>
                </section>
            </>
