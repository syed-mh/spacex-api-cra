    ...
    <>
      <section className="launch-opener">
        <div className="content-container">
          <div
            className="launch-image-container shadow-long rounded"
            style={backgroundImage.current}
          >
            <img
              className="mission-patch rounded shadow"
          ...
          <div className="launch-highlights-container">
            ...
            <h4 className="launch-date">
              {new Date(launch.date_utc).toLocaleDateString("en", {
                day: "numeric",
                month: "short",
                year: "numeric",
                hour: "numeric",
            ...
            <section className="external-links">
              ...
              {Object.values(launch.links.reddit) && (
                <a
                  href={Object.values(launch.links.reddit).find((item) => item)}
                  target="_blank"
                  rel="noreferrer noopener"
                >
            ...
            <section>
              ...
              <p
                className={`rounded shadow detail-info mission-status ${
                  launch.success === null
                    ? ""
                    : launch.success
                    ? "success"
            ...
            <section>
              ...
              <p className="detail-info">
                {launch.crew.length
                  ? `${launch.crew.length} Crew Members`
                  : "No"}
              </p>
            </section>
            <section>
              <h6>Launched From:</h6>
              <p className="detail-info">{`${launch.launchpad.full_name}`}</p>
              <p className="detail-info">
            ...
            <section>
              ...
              <p className="detail-info summary">{launch.details}</p>
            </section>
          </div>
        </div>
      </section>
