...
- If the unofficial API becomes too restrictive for the project in the future, I might consider directly calling the official [Space X GraphQl API](https://api.spacex.land/graphql/).
- I might consider adding a database to this project to cache and pre-process data to help with load-times. At the moment, performance does not appear to be an issue, but I'm looking to make this more of a full stack project in the future.
- A visual overhaul is also on my list of things to get to in the future, which could also include a dark mode toggle and a more "inspired" aesthetic.

# Documentation Generated by Create-React-App
